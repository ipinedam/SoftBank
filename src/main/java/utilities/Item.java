...
/**
 * The Item class is designed to be used by Swing components that use a renderer
 * to display an Object. Swing renderers rely on the toString() implementation
 * to display a description of an Object. Separating the value and description
 * properties gives increased flexibilty.
 *
 * The "description" property is used by the renderer. The "value" property is
 * used for processing by the application.
 *
 * @param <V>
 * @see
 * <a href="https://tips4java.wordpress.com/2013/02/18/combo-box-with-hidden-data/">
 * "Uso de ComboBox con valores ocultos"</a>
 */
public class Item<V> implements Comparable<Item> {
    ...
    /**
     * Implement the natural order for this class using the Description property
     *
