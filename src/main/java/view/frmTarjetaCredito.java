 ...
 */
public final class frmTarjetaCredito extends frmAppSoftBank {

    private CatalogoDAO cadao;
    private ClienteDAO cdao;
    private ProductoBancarioDAO pbdao;
    private TarjetaCreditoDAO tcdao;
    ...
    /**
     * Creates new form frmTarjetaCredito
     */
    public frmTarjetaCredito() {
        super();
        initComponents();
        // Título del formulario.
        this.setTitle("Tarjetas de Crédito");
        ...
        pnlTarjetaCredito.setFrmParent(this);
        ...
        UpcaseFilter.setFieldsToUpperCase(pnlTarjetaCredito);        
        ...
        // Ponemos la pantalla en modo "Tarjetas de Crédito".
        this.setJPAObject(cadao.getTarjetaCredito());
    ...
    public void setFormMode(PanelMode formMode) {
        ...
        switch (this.formMode) {
            case CRUD:
                ...
                pnlTarjetaCredito.setPanelMode(PanelMode.CRUD);
            ...
            case SELECTION:
                ...
                pnlCliente.setPanelMode(PanelMode.SELECTION);
                pnlProductoBancario.setPanelMode(PanelMode.READ_ONLY);
                pnlTarjetaCredito.setPanelMode(PanelMode.SELECTION);
            ...
            case READ_ONLY:
                ...
                pnlTarjetaCredito.setPanelMode(PanelMode.READ_ONLY);
    ...
    public void setFormAction(FormAction formAction) {
        ...
        switch (this.formAction) {
            case NEW:
                this.setTitle("Tarjetas de Crédito (Alta)");
                ...
                pnlTarjetaCredito.pnlTabla.setVisible(false);
                pnlTarjetaCredito.txtNumeroTarjeta.setFocusable(false);
                ...
                break;
            case CANCEL:
                this.setTitle("Tarjetas de Crédito (Cancelación)");

                pnlProductoBancario.pnlTabla.setVisible(true);

                pnlTarjetaCredito.txtImpLimiteTarjeta.setFocusable(false);
                pnlTarjetaCredito.txtTipoInteres.setFocusable(false);
                pnlTarjetaCredito.cbxCuentaCorrientePago.setEnabled(false);
                pnlTarjetaCredito.cbxFormaPago.setEnabled(false);                
                ...
                break;
            case MODIFY:
                this.setTitle("Tarjetas de Crédito (Modificación)");
            ...
            case MOVEMENT:
                this.setTitle("Tarjetas de Crédito (Movimientos)");
            ...
            case QUERY:
                this.setTitle("Tarjetas de Crédito (Visualización)");
    ...
    public void setJPAObject(Object jpaObject) {
        ...
        if (this.jpaObject instanceof ProductoBancario pb) {
            ...
            pnlTarjetaCredito.setJPAObject(pb.getTarjetaCredito());
        ...
        if (this.jpaObject instanceof Cliente c) {
            pnlTarjetaCredito.setJPAObject(c);
        }
        if (this.jpaObject instanceof TarjetaCredito tc) {
            this.tarjetaCredito = tc;
            this.productoBancario.setTarjetaCredito(tc);
        }        
    }
    ...
    protected void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        pnlTarjetaCredito.limpiarPanel();
    ...
    protected void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        tarjetaCredito = pnlTarjetaCredito.getJPAObject();
        ...
        // Creamos el producto bancario antes de insertar la tarjeta de credito.
        if (pbdao.insertarProductoBancario(productoBancario)) {
            // Asignamos a la tarjeta de crédito el producto bancario creado.
            tarjetaCredito.setProductoBancario(pbdao.getProductoBancario());
        } else {
        ...
        if (tcdao.insertarTarjetaCredito(tarjetaCredito)) {
            // Componemos el mensaje resultante de la creación.            
            String mensaje = String.format("Tarjeta de Crédito nº %s creada correctamente.",
                    tarjetaCredito.getNumeroTarjeta());      

            // Refrescamos los objetos de los paneles.
            pnlTarjetaCredito.setJPAObject(tarjetaCredito);
            ...
            // Error inesperado.
            setStatusBarText(tcdao.getMensaje());
            JOptionPane.showMessageDialog(this, tcdao.getMensaje(), this.getTitle(), JOptionPane.ERROR_MESSAGE);
        }
    }         
    ...
    protected void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        // Modificamos la tarjeta de crédito (tipo de interes).
        if (tcdao.actualizarTarjetaCredito(tarjetaCredito)) {
            // Componemos el mensaje resultante de la modificación.
            String mensaje = String.format("Tarjeta de Crédito nº %s modificada correctamente.",
                    tarjetaCredito.getNumeroTarjeta());
    ...
    protected void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        // Comprobación de que la tarjeta es cancelable.
        boolean cancelable = true;
        String mensaje = "";
        
        // Comprobamos que el saldo de la tarjeta es cero.
        if (tarjetaCredito.getImpSaldoPendiente().compareTo(BigDecimal.ZERO) != 0) {
            mensaje = mensaje + "- La tarjeta no tiene su saldo a 0.\n";
            cancelable = false;
        }
        
        if (!cancelable) {
            mensaje = "La tarjeta " + tarjetaCredito.getNumeroTarjeta() + " no puede cancelarse porque:\n" + mensaje;
            setStatusBarText(String.format("La Tarjeta de Crédito nº %s no puede cancelarse.",
                    tarjetaCredito.getNumeroTarjeta()));             
            JOptionPane.showMessageDialog(this, mensaje, "Tarjeta de Crédito", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Asignamos la fecha de hoy como fecha de cancelación de la tarjeta.
        ...
        if (pbdao.actualizarProductoBancario(productoBancario)) {
            ...
            mensaje = String.format("Tarjeta de Crédito nº %s cancelada correctamente.",
                    tarjetaCredito.getNumeroTarjeta());
    ...
    private void initComponents() {
        ...
        pnlTarjetaCredito = new view.pnlTarjetaCreditoTC(this.emf);
        ...
        pnlContenedor.add(pnlTarjetaCredito, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTarjetaCredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTarjetaCredito().setVisible(true);
            }
        });
    }
    ...
    protected view.pnlTarjetaCreditoTC pnlTarjetaCredito;
